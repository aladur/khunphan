...
Light::Light(bool AmbientLight /* = true*/, int LightSources /*= 1*/, bool Reflections /*= true*/) : posX (100.0), posY (180.0), posZ (50.0)
{
...
void Light::Update(bool AmbientLight, int aLightSources /*= 1*/, bool Reflections /*= true*/)
{
